...
def upgrade() -> None:
    ...
    try:
        ...
        print(f"⚠️ خطأ في إنشاء النوع schedulestatus: {e}")
    
    # ============================================================
    # الجزء 2: إنشاء جدول schedules
    # ============================================================
    try:
        if not table_exists('schedules'):
            ...
            if not column_exists('schedules', 'status'):
                op.add_column('schedules', sa.Column('status', sa.String(20), nullable=False, server_default='draft'))
        ...
        print(f"⚠️ خطأ في إنشاء جدول schedules: {e}")
    ...
    try:
        ...
        print(f"⚠️ خطأ في إنشاء جدول schedule_entries: {e}")
    ...
    try:
        ...
        print(f"⚠️ خطأ في إنشاء جدول schedule_templates: {e}")
    ...
    try:
        ...
        print(f"⚠️ خطأ في إنشاء جدول schedule_template_entries: {e}")
...
def downgrade() -> None:
    ...
    try:
        ...
        print(f"⚠️ خطأ في حذف schedule_template_entries: {e}")
    ...
    try:
        ...
        print(f"⚠️ خطأ في حذف schedule_templates: {e}")
    ...
    try:
        ...
        print(f"⚠️ خطأ في حذف schedule_entries: {e}")
    ...
    try:
        ...
        print(f"⚠️ خطأ في حذف schedules: {e}")
    ...
    try:
        ...
        print(f"⚠️ خطأ في حذف schedulestatus: {e}")
